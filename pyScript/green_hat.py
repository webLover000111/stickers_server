...
# OpenCV 人脸检测  
face_patterns = cv2.CascadeClassifier('/home/glenn/.local/lib/python2.7/site-packages/cv2/data/haarcascade_frontalface_default.xml')
sample_image = cv2.imread('11.jpg')   #你要加帽子的头像图像  
...
#    cv2.imwrite('face.png', sample_image);   #把人脸框出来.  
#    print (faces) 
  
  
# 圣诞帽  
#hats = []  
#for i in range(4):   #备选4顶帽子你去换  
#    hats.append(cv2.imread('hat%d.png' % i, -1))  
  
hat=cv2.imread('12345.png')    
cv2.imwrite('test.png', hat); 
...
#    hat = random.choice(hats)  
    ...
    # 透明部分的处理  
    alpha_h = hat[hat_y1:hat_y2, hat_x1:hat_x2, 2] / 255  
    alpha = 1 - alpha_h  
    # 按3个通道合并图片  
    for c in range(0, 3):  
